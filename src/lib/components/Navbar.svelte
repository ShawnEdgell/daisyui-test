...
<div class="navbar bg-base-100">
	<div class="navbar-start">
		<div class="dropdown">
			...
			<ul
				tabindex="0"
				class="menu dropdown-content menu-sm z-[1] mt-3 w-52 space-y-1 rounded-box bg-base-100 p-2 shadow"
			>
				{#each navLinks as { href, label }}
					<li>
						<a {href} class="btn-base btn no-underline">
							<span>{label}</span>
						</a>
					</li>
				{/each}
	...
	<div class="navbar-center">
		<a href="/" class="btn btn-ghost text-xl">Skatebit</a>
	</div>
